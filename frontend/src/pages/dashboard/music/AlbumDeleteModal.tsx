...
export default function AlbumDeleteModal({ isOpen, albumName, tracksCount, onClose, onConfirm }: AlbumDeleteModalProps) {
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md bg-[#0e1c1c] border border-white/[0.08] rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                <div className="p-6 text-center space-y-4 mt-2">
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-white mb-1.5">Hapus Playlist?</h3>
                        <p className="text-sm text-gray-400 leading-relaxed">
                            Yakin ingin menghapus playlist <span className="text-gray-200 font-medium">"{albumName}"</span> yang berisi <span className="text-gray-200">{tracksCount} lagu</span>?<br />
                            <span className="text-amber-400/80 text-xs mt-1 block">Catatan: Lagu-lagu di dalamnya <strong>tidak</strong> akan ikut terhapus.</span>
                        </p>
                    </div>
                </div>
